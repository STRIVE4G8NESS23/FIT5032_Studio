...
namespace FIT5032_MyModelFirst.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ids,FirstName,lastName")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ids,FirstName,lastName")] Student student)
        {
            if (ModelState.IsValid)
            {
